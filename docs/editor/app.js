...
(() => {
  ...
  var FACTORY_TEMPLATES = Object.freeze([
    ...
    tpl(
      "pv-energy",
      "PV-Energiefluss",
      "Photovoltaik, Wechselrichter, Batterie, Netz, Haus \u2014 alle Energiefl\xFCsse.",
      "PV-Energiefluss",
      "Erzeugung \xB7 Speicher \xB7 Netz \xB7 Verbrauch",
      [
        eq("pv", "generic", "PV-Anlage", "Generator", 130, 255, 285, 185, ["Leistung", "Ertrag heute"]),
        ...
        eq("netz", "grid", "Netzanschluss", "Bezug / Einspeisung", 1160, 200, 260, 185, ["Leistung", "Z\xE4hlerstand"]),
    ...
    tpl(
      ...
      [
        ...
        eq("station", "solar_station", "Solarstation", "Kreislaufs", 640, 200, 260, 230, ["Vorlauf", "R\xFCcklauf", "Pumpenleistung"]),
    ...
    tpl(
      "pv-hp",
      "PV + Speicher + WP",
      "Photovoltaik, Batterie und W\xE4rmepumpe in einem Bild.",
      "PV & W\xE4rmepumpe",
      "Strom und W\xE4rme kombiniert",
      [
        ...
        eq("netz", "grid", "Netzanschluss", "\xDCbergabepunkt", 130, 560, 260, 185, ["Leistung", "Z\xE4hlerstand"]),
        eq("wp", "heat_pump", "W\xE4rmepumpe", "Verbraucher", 560, 500, 280, 200, ["Leistung", "Vorlauf", "COP"])
      ],
      [
    ...
    tpl(
      "cascade",
      "WP-Kaskade",
      "Zwei W\xE4rmepumpen am gemeinsamen Puffer.",
      "W\xE4rmepumpen-Kaskade",
      "Kaskade mit gemeinsamer Hydraulik",
      [
        eq("wp1", "heat_pump_duo", "W\xE4rmepumpe 1", "Kaskade Stufe 1", 130, 180, 285, 185, ["Vorlauf", "R\xFCcklauf", "Leistung"]),
        eq("wp2", "heat_pump_duo", "W\xE4rmepumpe 2", "Kaskade Stufe 2", 130, 500, 285, 185, ["Vorlauf", "R\xFCcklauf", "Leistung"]),
      ...
      [kpi("Gesamtleistung", "mdi:heat-pump-outline"), kpi("Puffer oben", "mdi:thermometer-high"), kpi("Au\xDFen", "mdi:weather-partly-rainy")]
    ),
    tpl(
      "boiler-solar",
      "Kessel + Solar",
      "Konventioneller Kessel mit Solarunterst\xFCtzung.",
      "Kessel & Solar",
      "Kessel mit Solarunterst\xFCtzung",
      [
        eq("kessel", "boiler", "Heizkessel", "Haupterzeuger", 130, 305, 285, 185, ["Kesseltemperatur", "Leistung"]),
        eq("solar", "solar_station", "Solarstation", "Unterst\xFCtzung", 640, 180, 260, 230, ["Kollektor", "R\xFCcklauf"]),
  ...
  var ENTRIES = Object.freeze({
    ...
    "legacy.dialog_close": "Schlie\xDFen",
    ...
    "legacy.menu": "Men\xFC",
    "legacy.menu_operation": "Bedienung",
    "legacy.menu_style": "Stil",
    "legacy.menu_view": "Ansicht",
    ...
    "legacy.trend_chart": "Trend-Diagramm",
    ...
    "symbols.symbol_booster_station": "Druckerh\xF6hungsanlage",
    ...
    "symbols.symbol_duct": "Kanalst\xFCck",
    ...
    "symbols.symbol_flue": "Abgasf\xFChrung",
    ...
    "symbols.symbol_oil_separator": "\xD6labscheider",
    ...
    "symbols.symbol_receiver_drier": "Fl\xFCssigkeitstrockner",
    ...
    "symbols.symbol_suction_accumulator": "Saugbeh\xE4lter",
    ...
    "symbols.symbol_y_strainer": "Y-Schmutzf\xE4nger",
